...
asteroid_spawn_distance = 500000 # How close the asteroids spawn and how far away they will fly to
...
asteroid_total = []
missle_total = []
asteroid_max = 800 # The maximum number of asteroids ***** MUST BE AN EVEN NUMBER  and make sur eto modify loop_test_number global variable*****
...
last_frame_mpos_x = 0
last_frame_mpos_y = 0
asteroid_test_distance = 500000 #The test distance. If asteroid greater than asteroid_test_distancem then it will be moved closer
...
class Begin(ShowBase):
    ...
    def createAsteroids(self):
        for i in range(0,asteroid_max):
            ...
            asteroid_total.append(Asteroid())
...
class Asteroid(object):
    def __init__(self, step=36, radius=1000):
        ...
        np.setPos(self.get_sphere_points(spawn_distance, base.camera))
    ...
    def simplex_radius(self, radius, seed, xoff, yoff, zoff):
        ...
        return self.translate(noise.noise3d(xoff,yoff,zoff),0,1,1000,1500)
        #return radius
    ...
    def create_map(self, radius):
        ...
        for x in range(0, 181, self.step):
            ...
            if x == 0:
                ...
                map[(0,0)] = (0,0,point_radius, (self.translate(point_radius, 1000, 1500, 0.3, 0.5)))
            elif x == 180:
                point_radius = -(self.simplex_radius(radius, seed, 0, 0, -1)) 
                map[(180,0)] = (0,0,point_radius, (self.translate(point_radius, -1000, -1500, 0.3, 0.5)))
            #The rest of the sphere
                ...
                for y in range(0, 361, self.step):
                    ...
                    map[(x ,y)] = (v_x, v_y, v_z, (self.translate(point_radius, 1000, 1500, 0.3, 0.7)))
                    #print(map[(x,y)])
        return map 
...
class Missle(object):
    def __init__(self):
        ...
        plight.setAttenuation(LVector3(0, 0.00004 , 0))
